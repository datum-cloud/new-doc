...
|---|---|---|
| [Application Load Balancer](/agents/skills/ai-edge) | WAF, traffic protection, auth policies | TrafficProtectionPolicy, SecurityPolicy, BackendTrafficPolicy, Gateway, HTTPRoute |
